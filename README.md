...
Let's play Torpedex! Clone or open https://github.com/petergpt/torpedex, read `CODEX_INSTRUCTIONS.md`, launch it at http://127.0.0.1:3197 if available, or use another local port and tell me that URL, then stay in the captain's chair as the live opponent until I say stop.
