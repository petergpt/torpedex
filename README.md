...
```text
Let's play Torpedex! Clone or open https://github.com/petergpt/torpedex, read CODEX_INSTRUCTIONS.md, get it running, tell me the local game URL, and stay in the captain's chair as the live opponent until I say stop.
```
